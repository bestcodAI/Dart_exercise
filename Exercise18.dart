...
void theGame(List<List<int>> board){
  /*
  Accept: list of list of integers 
  Does: first checks the rows, then column then diagonals and prints the 
  results if conditions are met 
  Returns: nothing
   */
  if(rowCheck(board)){
    print("Row wins");
